...
\textbf{Email:} &  \href{mailto:yzhou@virginia.edu}{yzhou@virginia.edu} & & & & \textbf{Place:} & Astronomy Building\\
\textbf{Office Hours:}  &&&&
\end{tabular}
\end{minipage}
\rule{6in}{0.4pt}
...
\noindent Cutting-edge astronomy demands  how reliably they say it. By the end of this course, you will be able to:
\begin{itemize}
...
\vskip.1in
\noindent\textbf{Goal 2: Formulate the questions}
