...
\vskip.1in
\noindent\textbf{Goal 1: Master the signals in your data}

\noindent Cutting-edge astronomy demands that you know how reliably they say it. You will be able to:
\begin{itemize}
  \item Describe the fundamentals of telescope optical design, detector physics, and photon collection at optical and infrared wavelengths.
  \item Collect, reduce, and analyze astronomical datasets using imaging, spectroscopy, and interferometry techniques.
  \item Quantify signals and uncertainties through hands-on data analysis activities and nightlab sessions.
\end{itemize}

\vskip.1in
\noindent\textbf{Goal 2: Formulate the right questions}
...
\vskip.1in
\noindent\textbf{Goal 3: Design the experiment}
...
\begin{itemize}
  ...
  \item Execute observing programs through hands-on laboratory work.
\end{itemize}

\vskip.1in
\noindent\textbf{Goal 4: Compete for resources}

\noindent Cutting edge astronomical facilities, grants, and fellowship opportunities are oversubscribed. Effective writing and presentation determine who gets access. By the end of this course, you will be able to:
\begin{itemize}
...
\vskip.1in
\noindent\textbf{Goal 5: Apply these skills broadly}
