...
% ============================================================
\sectionheading{Grading Policy and Assessment}

\subsectionheading{Night Labs}
Throughout the semester, you will conduct five night labs. These labs are designed to help you synthesize lecture content, prepare for observing trips, use astronomical facilities, analyze data, and present results in written and oral formats.
For each lab, you will complete a preparation worksheet. The worksheet includes a problem set covering optics and astronomical concepts from lecture, along with assigned readings and procedures to prepare for the night observations. You will collect data using campus telescopes, analyze the data, and write a lab report formatted in American Astronomical Society journal style. You will also prepare a short presentation to share your results with the class. You will provide constructive feedback on each other's reports and presentations.
The preparation worksheet is completed individually. Data collection, analysis, the lab report, and the presentation are done in groups.
Each lab accounts for 10% of your final grade, for a total of 50%.
\subsectionheading{Observing Proposal and Peer Review}
During the semester, you will write one telescope observing proposal on a topic of your choice. The proposal should identify a scientific question, describe the observing experiment, and justify the telescope time request. You will also deliver a class presentation making the case for your proposal.
As audience members, you will ask questions about the experimental design, request justifications, discuss risk mitigation, and evaluate scientific impact. You will write a constructive referee report for one proposal.
This component accounts for 20% of your final grade: 8% for the written proposal, 8% for the presentation, and 4% for peer review.
\subsectionheading{Field Trip and Final Project}
We will conduct a week-long field trip to observatories in the Southwest US. Along with visits to professional facilities (Kitt Peak, the Large Binocular Telescope, Apache Point Observatory), you will experience a professional observing run. You will
\begin{itemize}
\item Select observing proposals and programs
\item Prepare necessary documents
\item Learn to operate professional telescopes
\item Work with observatory staff to collect data
\item Analyze the data and write a journal-style term paper
\item Plan and manage the logistics of an observing run (scheduling, travel, food, etc.)
\end{itemize}
The field trip and final project account for 30\% of your final grade: 10\% for trip preparation, 10\% for telescope observations, and 10\% for the term paper.
...
\hline
Nightlabs & 50\% \\
Observing proposal and peer reviews & 20\% \\
Field trip and final project  & 30\% \\
\hline
\end{tabular}
\end{center}
